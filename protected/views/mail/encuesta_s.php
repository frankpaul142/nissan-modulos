...
<table width="700px" border="0">
  ...
  <td style="\text-align:center;
	...
	#F2F2F2;"><?php echo $satisfaction->suggestion->client->identity ?></label></a><br/>
<a>Nombre:<label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->suggestion->client->name ?></label></a>
<br/>
<a>Apellido:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->suggestion->client->lastname ?></label>
    </a>
<br/>
<a>E-mail:
   <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->suggestion->client->email ?></label></a>
<br/>
<a>Tel&eacute;fono:
   <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->suggestion->client->phone ?></label></a>
<br/>
<a>Celular:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->suggestion->client->cellphone ?></label></a>    
<br/>
<a>Concesionario:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->suggestion->concessioner->name ?></label></a>          	
