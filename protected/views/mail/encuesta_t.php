...
<table width="700px" border="0">
  ...
  <td style="\text-align:center;
	...
	#F2F2F2;"><?php echo $satisfaction->technical->client->identity ?></label></a><br/>
<a>Nombre:<label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->technical->client->name ?></label></a>
<br/>
<a>Apellido:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->technical->client->lastname ?></label>
    </a>
<br/>
<a>E-mail:
   <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->technical->client->email ?></label></a>
<br/>
<a>Tel&eacute;fono:
   <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->technical->client->phone ?></label></a>
<br/>
<a>Celular:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->technical->client->cellphone ?></label></a>    
<br/>
<a>Concesionario:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->technical->concessioner->name ?></label></a>          	
