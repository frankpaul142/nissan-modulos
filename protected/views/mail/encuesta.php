...
<table width="700px" border="0">
  ...
  <td style="\text-align:center;
	...
	#F2F2F2;"><?php echo $satisfaction->quotation->client->identity ?></label></a><br/>
<a>Nombre:<label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->quotation->client->name ?></label></a>
<br/>
<a>Apellido:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->quotation->client->lastname ?></label>
    </a>
<br/>
<a>E-mail:
   <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->quotation->client->email ?></label></a>
<br/>
<a>Tel&eacute;fono:
   <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->quotation->client->phone ?></label></a>
<br/>
<a>Celular:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->quotation->client->cellphone ?></label></a>    
<br/>
<a>Concesionario:
    <label style="background-color:
	#F2F2F2;"><?php echo $satisfaction->quotation->concessioner->name ?></label></a>          	
