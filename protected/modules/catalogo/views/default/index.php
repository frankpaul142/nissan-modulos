  ...
  <section class="modulos">
      <h1>PRUEBA DE MANEJO</h1>
        <div class="cont-formulario">
          <div class="botoneras">
              <ul>
                  <li id="btn-1" class="seleccion"><img src="images/modulos/btn-infopersonal-hover.jpg" /></li>
                    <li id="btn-2"><img src="images/modulos/btn-escojasumodelo.jpg" /></li>
                    <li id="btn-3"><img src="images/modulos/btn-escojasumodelo.jpg" /></li>
                </ul>
            </div>
            <!-- FORMULARIO MODULOS -->
                ...
                <div id="modulo-fase1">
                  <div class="formularios-mod">
                      <h1>Información Personal</h1>                     
                        ...
                        <input type="submit" value="Siguiente" class="btns-submit"/>
                    </div>
                    <div class="formularios-mod">
                       <h1>Selecciona los modelos de vehículos</h1>
                      <div class="carros-check">
                          <img src="images/autos/auto1.png"/>
                          <input type="checkbox"/>
                       ...
                       <div class="carros-check">
                          <img src="images/autos/auto1.png"/>
                       <input type="checkbox"/>
                         <label>Nissan Note</label>
                       </div>
                       <div class="carros-check">
                          <img src="images/autos/auto1.png"/>
                       <input type="checkbox"/>
                         <label>Nuevo Xtrail</label>
                       </div>
                    ...
                    <div class="formularios-mod">
                       ...
                       <div class="carros-check">
                          <img src="images/autos/auto1.png" alt="auto nissan"/>
