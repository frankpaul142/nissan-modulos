...
<body style="font-family:Arial, Helvetica, sans-serif; color:#4D4D4F; font-size:15px; background: #e7e7e7; /* Old browsers */
	...
	'enableAjaxValidation'=>false,
    	...
    	<h1 style="font-size:18px; font-weight:bold">Estimad@ <?php echo $replacement->client->name." ".$replacement->client->lastname  ?></h1>
        <p>Han pasado 48 horas desde que recibimos su requerimiento en <strong>www.nissan.com.ec</strong></p>
        <p><strong>¿Podría por favor confirmarnos si nuestro asesor de repuestos se ha contactado con usted y le ha facilitado toda la información solicitada?</strong></p>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#SatisfactionR_score").change(function() {
           if($(this).val()==10){
