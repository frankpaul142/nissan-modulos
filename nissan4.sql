/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     12/11/2014 15:00:41                          */
/*==============================================================*/
...
(
   ...
   client_id            int not null,
   vehicle_version_id2  int not null,
   creation_date        datetime not null,
   primary key (id)
);
...
alter table drive add constraint fk_cliente_manejo foreign key (client_id)
      references client (id) on delete restrict on update restrict;

alter table drive add constraint fk_concesionario_manejo foreign key (concessioner_id)
      references concessioner (id) on delete restrict on update restrict;

alter table drive add constraint fk_manejo_vehiculo1 foreign key (vehicle_version_id2)
      references vehicle_version (id) on delete restrict on update restrict;

alter table drive add constraint fk_manejo_vehiculo2 foreign key (vehicle_version_id)
      references vehicle_version (id) on delete restrict on update restrict;
